...
//		ObjectMapper mapper = new ObjectMapper(); //매퍼 클래스 생성
//		mapper.configure(DeserializationFeature.FAIL_ON_UNKNOWN_PROPERTIES, false); //분석할 수 없는 구문을 무시하는 옵션 설정
//		String weather = getWeather(); //날씨 데이터 가져오기
//		ResponseResult response = null;
//		response = mapper.readValue(weather, ResponseResult.class); //JSON 문자열을 클래스로 변환
