...
public class BoardController {
	...
	public String register(BoardDto boardDto, RedirectAttributes rttr, Principal principal) { /* 시큐리티에서 사용자 인증객체 가져오기 */
		String id = principal.getName(); //사용자 아이디 가져오기
		boardDto.setWriter(id); //작성자 필드에 아이디 저장하기
